      ...
      <ModalContent bg="whiteAlpha.900">
        <ModalBody>
          ...
          <Box px="16" mb="16" fontSize="sm">
            <Text mb="4">Because XRPL NFT-Dev net is under development, the Itoka IC-XRP cross-chain project is for R&D purpose, and the Itoka team airdropped the Bazahei NFTs to the community for free. The XRPL NFT-Dev net will be reset and merged to the main net in the future. Please pay attention to the Ripple Labs announcement.</Text>
            <Text mb="4">XRPL NFT-Dev is for experiencing only. We extremely recommend stake NFT assets on the Internet Computer network.</Text>
